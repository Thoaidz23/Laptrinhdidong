...
import 'search_screen.dart'; // ✅ Thêm dòng này
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    MaterialPageRoute(
    builder: (context) =>
    SearchScreen(keyword: value.trim()), // ✅ Điều hướng tới SearchScreen
    ),
    );
    }
    },
    ...
    border: InputBorder.none,contentPadding: const EdgeInsets.symmetric(vertical: 14, horizontal: 20),
    ),
    ),
    ),
    ],
